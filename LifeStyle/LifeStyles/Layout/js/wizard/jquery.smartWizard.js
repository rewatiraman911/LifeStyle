...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        //finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-default").attr("Id","btnSave")
        finish : $('<input type="submit" id="btnSubmit" name="btnSubmit" value="Save" class="btn btn-warning" style="display:none">'),
        //save: $('<input type="submit" id="btnSave" name="btnSave" value="Save" class="btn btn-primary">')
        publish: $('<input type="submit" id="btnPublish" name="btnPublish" value="Publish" class="btn btn-dark" style="display:none">')
    };
    ...
    var _init = function($this) {
        ...
        if ($this.options.includePublishButton) {
            elmActionBar.append($this.buttons.publish)
        }
        ...
        $($this.buttons.previous).click(function() {
         ...
         $($this.buttons.publish).click(function() {
           // $this.goBackward();
            return false;
        });
...
//        //for save and pubish button 26feb
//        $($this.buttons.save).click(function () {
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        includePublishButton : true   // Add the publish button
    };
